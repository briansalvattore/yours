...
//        imageViewParam.setMargins(0, iconMargin, iconMargin, 0);
        ...
        mSwitchCamera.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.ic_camera_front_white_24dp));
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread() {
                    ...
                    @Override
                    public void run() {
                        Log.d(TAG, "run() called with: camera=[" + CameraInterface.getInstance().getSelectedCamera() + "]");
